...
public interface Constants {
    ...
    public static final int TILES_4_COLUMN = 30;
    ...
    public static final long SEC_ERASE_MATTONE = 7000; //numero di millisecondi per il quale il mattone deve rimanere cancellato
